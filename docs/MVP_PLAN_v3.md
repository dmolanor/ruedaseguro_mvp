...
*Supersedes MVP_ARCHITECTURE.md (v2.0)*
*Next document: Sprint Issues (to be created from Section 12)*
*Update triggers: William/Manuel discovery session, GuiaPay docs from Alex, Thony's MQTT broker specs*
