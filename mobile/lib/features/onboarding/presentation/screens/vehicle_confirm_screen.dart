...
class VehicleConfirmScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VehicleConfirmScreen> createState() =>
      _VehicleConfirmScreenState();
}
            ...
            children: [
                    ...
                    children: [
                      ...
                      if (hasMismatch) ...[
                        ...
                        RSButton(
                          ...
                          onPressed: () => context.go('/onboarding/cedula'),
                          isFullWidth: false,
                        ),
              ...
              _ConfField(
                ...
                validator: (v) {
                  ...
                  if (y < 1980 || y > DateTime.now().year + 1)
                    return 'Año inválido';
                  return null;
                },
              ),
              ...
              RSButton(
                label: 'Continuar',
                onPressed: (hasMismatch && !_isLegalRepresentative)
                    ? null
                    : _submit,
              ),
